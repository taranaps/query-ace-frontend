...
/**
* Properties for the SortFilterButton component.
* @typedef {Object} SortFilterButtonProps
* @property {SxProps} [sx] - Optional styling properties for the component, typically used for customizing the appearance.
* @property {"newest" | "earliest"} sortOrder - The current sort order, either "newest" or "earliest".
* @property {function("newest" | "earliest"): void} onSortChange - Callback function triggered when the sort order changes. 
* Receives the new sort order ("newest" or "earliest") as an argument.
*/
